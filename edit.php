		...
		<div id="overview">
			...
			<div class="container">
				...
				<div class="textbox">
					<input name="client_id" id="client_id" type="text" value="' . $row['client_id'] . '" required />
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="textbox">
					<input name="client" id="client" type="text" value="' . $row['client'] . '" required autofocus/>
				</div>
			</div>
			<div class="miniPush"></div>
			<div class="container">
		...
		<div id="send">
			...
			<input id="send" type="submit" class="button" name="submit" value="PREVIEW SEND BRIEF" formaction="preview.php?id=' . $row['client_id'] . '" />
		</div>
		<div class="miniPush"></div>
	</div>
	</form>';
